...
angular.module("wxz-ng-image-viewer").run(["$templateCache", function($templateCache) {$templateCache.put("../src/template.html","<div class=wxz-img-view-cont><canvas class=wxz-img-view-canvas></canvas><div class=\"wxz-scale-value fade out\"></div></div>");}]);